...
# Client-centric consistency - default input file from the assignment - noa graphical interface - pretty print JSON
...
#../bin/python3 Main.py -i ccc1.json -o ccc_output1.json -c ccc_output_clock1.json -pTrue -wTrue
